	...
	function map_shortcode() {
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Separator', 'bold-builder' ), 'description' => esc_html__( 'Separator line', 'bold-builder' ), 'icon' => $this->prefix_backend . 'icon' . '_' . $this->shortcode,
			'params' => array( 
				...
				array( 'param_name' => 'border_color', 'type' => 'dropdown', 'heading' => esc_html__( 'Border color', 'bold-builder' ), 'preview' => true,
					'value' => array(
						esc_html__( 'Inherit', 'cliniq' ) 			=> '',
						esc_html__( 'Dark color', 'cliniq' ) 		=> 'dark',
						esc_html__( 'Light color', 'cliniq' ) 		=> 'light',
						esc_html__( 'Dark gray color', 'cliniq' ) 		=> 'gray',
						esc_html__( 'Light gray color', 'cliniq' ) 		=> 'light_gray',
